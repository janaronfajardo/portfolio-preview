      ...
      <div className="mb-8 md:mb-12">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 brutal-border bg-paper dark:bg-ink text-black dark:text-white font-mono text-sm focus:outline-none focus:shadow-brutal-accent transition-all"
          />
        </div>
      </div>
